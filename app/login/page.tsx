    ...
    <main className="mx-auto flex min-h-screen w-full max-w-3xl items-center px-4 py-10 sm:px-6 lg:px-8">
      <div className="w-full rounded-3xl border border-slate-200 bg-white p-8 shadow-soft">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Google OAuth is now wired at the framework level. The next implementation step is persisting users and sessions into D1.
        </p>
        ...
        <div className="mt-8 space-y-4">
          {googleConfigured ? (
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
              Google OAuth is not configured yet. Add <code>AUTH_GOOGLE_ID</code>, <code>AUTH_GOOGLE_SECRET</code>, and <code>AUTH_SECRET</code> to enable login.
            </div>
          )}
