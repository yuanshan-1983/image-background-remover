      ...
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Continue with Google to start removing backgrounds.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-3">
          {googleConfigured ? (
            <a
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-gray-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-gray-800"
            >
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Free plan: 5 background removals per day.
        </p>
      </div>
    </main>
  );
